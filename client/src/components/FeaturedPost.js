	...
	<div className="card-columns listfeaturedtag">
		...
		<div className="card">
			<div className="row">
				<div className="col-md-5 wrapthumbnail">
					<a href="/post">
						<div className="thumbnail" styles="background-image:url(assets/img/demopic/1.jpg);">
						</div>
					</a>
				</div>
				<div className="col-md-7">
					<div className="card-block">
						<h2 className="card-title"><a href="/post">We're living some strange times</a></h2>
						...
						<div className="metafooter">
							<div className="wrapfooter">
								...
								<span className="post-name"><a href="/author">Steve</a></span><br/>
		...
		<div className="card">
			<div className="row">
				<div className="col-md-5 wrapthumbnail">
					<a href="/post">
						<div className="thumbnail" styles="background-image:url(assets/img/demopic/4.jpg);">
						</div>
					</a>
				</div>
				<div className="col-md-7">
					<div className="card-block">
						<h2 className="card-title"><a href="/post">San Francisco at its best view in all seasons</a></h2>
						<h4 className="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</h4>
						<div className="metafooter">
							<div className="wrapfooter">
								<span className="meta-footer-thumb">
