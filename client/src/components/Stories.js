	...
	<div className="card-columns listrecent">
		...
		<div className="card">
			...
			<div className="card-block">
				<h2 className="card-title"><a href="/post">Autumn doesn't have to be nostalgic, you know?</a></h2>
		...
		<div className="card">
			...
			<div className="card-block">
				<h2 className="card-title"><a href="/post">Best galleries in the world with photos</a></h2>
				<h4 className="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</h4>
				<div className="metafooter">
					<div className="wrapfooter">
						<span className="meta-footer-thumb">
		...
		<div className="card">
			...
			<div className="card-block">
				<h2 className="card-title"><a href="/post">Little red dress and a perfect summer</a></h2>
				<h4 className="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</h4>
				<div className="metafooter">
					<div className="wrapfooter">
						<span className="meta-footer-thumb">
